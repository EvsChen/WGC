...
class PingPong {
  ...
  startLoading() {
    ...
    console.log('evschen: loading started');
    Promise.all([
      this.scene.setup(),
      this.loadModeChooserAnimation(),
      this.loadingAnimation(),
    ]).then(() => {
      console.log('evschen: loading finished');
      this.introAnimation();
    }).catch(e => {
      console.warn(e);
    });
    ...
    return new Promise(resolve => {
      TweenMax.to('header span', 0.5, {
        ...
        onComplete: () => {
          ...
          $('header span').remove();
          console.log('evschen: loading animation finished');
          resolve();
        },
      });
    });
  ...
  introAnimation() {
    ...
    console.log('evschen: intro anime finished');
    this.startBallTween();
  }
    ...
    return Promise.all([
      new Promise(resolve => {
        $.getJSON('/animations/1player-v3.json', data => {
          ...
          console.log('evschen: loadModeChooserAnimation 1 finished');
          resolve();
        });
      }),
      new Promise(resolve => {
        $.getJSON('/animations/2player-v3.json', data => {
          ...
          console.log('evschen: loadModeChooserAnimation 2 finished');
          resolve();
        });
      }),
    ]);
